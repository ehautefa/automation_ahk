; Script d'Automatisation : MACRO_ACTIVER_FILAIRE
; Généré automatiquement par step2_generate_automation.ahk
; Touche de raccourci : F3
...
MsgBox("=== MACRO_ACTIVER_FILAIRE ===`n`nScript d'automatisation prêt !`n`nAppuyez sur F3 pour lancer l'automatisation.`nAppuyez sur ESC pour quitter.")
