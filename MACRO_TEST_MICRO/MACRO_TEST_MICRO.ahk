; Script d'Automatisation : MACRO_TEST_MICRO
; Généré automatiquement par step2_generate_automation.ahk
; Touche de raccourci : F2
...
MsgBox("=== MACRO_TEST_MICRO ===`n`nScript d'automatisation prêt !`n`nAppuyez sur F2 pour lancer l'automatisation.`nAppuyez sur ESC pour quitter.")
